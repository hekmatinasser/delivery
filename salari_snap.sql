...
--
-- Host: 127.0.0.1
-- Generation Time: May 24, 2023 at 08:38 PM
...
CREATE TABLE `users` (
  ...
  `nationalCode` varchar(15) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `nationalPhoto` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `address` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `unValidCodeCount` int(1) NOT NULL DEFAULT 0,
...
CREATE TABLE `vehicle` (
  ...
  `pelak` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
